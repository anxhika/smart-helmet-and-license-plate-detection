                    ...
                    for *xyxy, conf, cls in det:
                        ...
                        if names[c] == 'Rider':
                            ...
                            try:
                                ...
                                if x2 > x1 and y2 > y1:  # Valid crop region
                                    ...
                                    if roi.size > 0:  # Ensure ROI is not empty
                                        ...
                                        print("Warning: Empty ROI, skipping crop")
                                else:
                                    print("Warning: Invalid crop region")
                            except Exception as e:
                                print("Error cropping region:", str(e))
                            ...
                            if str(rider_helmet_status)+'\n'+str(rider_lp_status)+'\n'+str(rider_lp_number)+'\n'+str(no_of_passengers) not in existingOutputs:
                                ...
                                output_txt = f'laneOutput/det_{imgCounter}.txt'
...
# start_detecttion(r"./test_images_videos/498490_1_En_37_Fig2_HTML.png")